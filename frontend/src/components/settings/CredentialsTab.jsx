...
const CREDENTIAL_FIELDS = [
  ...
  },
  {
    ...
    placeholderKey: 'https://api.cognitive.microsofttranslator.com',
              ...
              <>
                ...
                {field.key === 'HF_TOKEN' && (
                  <Badge tone={info?.has_hf_token || saved.HF_TOKEN ? 'success' : 'warn'} size="xs">
                    {info?.has_hf_token || saved.HF_TOKEN
                      ? t('credentials.saved')
                      : t('credentials.not_set')}
                  </Badge>
                )}
              </>
            }
                ...
                {field.link && (
                  <>
                    ...
                    <a
                      ...
                      onClick={(e) => {
                        e.preventDefault();
                        openExternal(field.link);
                      }}
                    >
                      {t('credentials.get_token')}
                    </a>
                  </>
                )}
              </>
